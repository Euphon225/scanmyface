...
export declare class Pools {
    private STEP_SIZE;
    private POLL_DEBOUNCE;
    private pollMaxDebounces;
    private POLL_DEFAULT_VALUE;
    private client?;
    ...
    waitForAttributeDeletion: (databaseId: string, collectionId: string, attributeKeys: any[], iteration?: number) => Promise<boolean>;
