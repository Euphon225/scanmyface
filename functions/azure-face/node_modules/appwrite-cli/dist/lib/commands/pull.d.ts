...
import { Client, Models } from "@appwrite.io/console";
...
export declare class Pull {
    ...
    private silent;
    constructor(projectClient: Client, consoleClient: Client, silent?: boolean);
    /**
     * Set the base directory path for config files and resources
     */
    setConfigDirectoryPath(path: string): void;
    /**
     ...
     */
    pullResources(config: ConfigType, options?: PullOptions): Promise<ConfigType>;
    /**
     * Pull project settings
     */
    pullSettings(projectId: string): Promise<PullSettingsResult>;
    /**
     * Pull functions from the project
     */
    pullFunctions(options?: PullFunctionsOptions): Promise<FunctionType[]>;
    /**
     * Pull sites from the project
     */
    pullSites(options?: PullSitesOptions): Promise<SiteType[]>;
    /**
     * Pull collections from the project (deprecated)
     */
    pullCollections(): Promise<{
        databases: any[];
        collections: any[];
    }>;
    /**
     ...
     */
    pullBuckets(): Promise<any[]>;
    /**
     * Pull teams from the project
     */
    pullTeams(): Promise<any[]>;
    /**
     * Pull webhooks from the project
     */
    pullWebhooks(): Promise<any[]>;
    /**
     * Pull messaging topics from the project
     */
    pullMessagingTopics(): Promise<any[]>;
}
/** Helper methods for CLI commands */
export declare const pullResources: ({ skipDeprecated, }?: {
    skipDeprecated?: boolean;
}) => Promise<void>;
