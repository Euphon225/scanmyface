...
export declare const questionsPushFunctionsActivate: Question[];
...
export declare const questionsPushSitesActivate: Question[];
...
export declare const questionsGetBuildCommand: Question[];
export declare const questionsPushTeams: Question[];
export declare const questionsPushWebhooks: Question[];
